...
<h2 className='text-[#00df9a] text-[20px] font-bold'>GROWING WITH DATA ANALYTICS</h2>
...
<div className='flex justify-center items-center'>
    ...
    Monitor your data analytics to increase revenue for BTB,BTC & SASS platforms</h2>
